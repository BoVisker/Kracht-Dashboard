...
import { PlannedSessionsManager } from '../components/PlannedSessionsManager'
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <Card title="Trainingsplan" subtitle="Weekschema plannen (welke dag push/pull/legs/cardio) — los van de Push/Pull/Legs-classificatie op de Training-pagina, die leest wat je al deed." className="md:col-span-2">
          {isSupabaseConfigured() ? <PlannedSessionsManager /> : <p className="text-sm text-text-muted">Vereist een gekoppeld Supabase-project — zie README.md.</p>}
        </Card>
        ...
        <Card title="Units & privacy" subtitle="kg/lbs, km/mi, data-export en verwijderen." className="md:col-span-2">
          {isSupabaseConfigured() ? <ProfileSettingsManager /> : <p className="text-sm text-text-muted">Vereist een gekoppeld Supabase-project — zie README.md.</p>}
        </Card>
      </div>
    </div>
  )
